...
public class AuthController {
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "400", description = "잘못된 이메일/비밀번호 형식"),
                    @ApiResponse(responseCode = "404", description = "해당 사용자를 찾을 수 없음"),
                    @ApiResponse(responseCode = "500", description = "메일 전송 실패")
            }
    )
    public ResponseEntity<Void> findPassword(@Valid @RequestBody MailRequest request) {
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "400", description = "잘못된 형식 혹은 비밀번호와 비밀번호 확인이 일치하지 않음"),
                    @ApiResponse(responseCode = "404", description = "해당 사용자를 찾을 수 없음"),
            }
    )
