...
public class QRolePermission extends EntityPathBase<RolePermission> {
    ...
    private static final long serialVersionUID = -373097971L;
    ...
    public final com.jiwon.mylog.domain.permission.QPermission permission;
    ...
    public QRolePermission(Class<? extends RolePermission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.permission = inits.isInitialized("permission") ? new com.jiwon.mylog.domain.permission.QPermission(forProperty("permission")) : null;
